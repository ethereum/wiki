...
1. `Object` - The transaction object
  ...
  - `gas`: `HEX String`  - (optional, default: <ToBeDetermined>) Integer of the gas provided for the transaction execution. It will return unused gas.
  - `gasPrice`: `HEX String`  - (optional, default: <ToBeDetermined>) Integer of the gasPrice used for each payed gas

...
　この項の目的は、契約の生成とDアプリ開発の視点から Ethereum を理解するのに必要な基礎知識の紹介である。Ethereumの導入としては、ふつう、はじめに白書に目を通し、さらに技術スペックを網羅するためにYellow Paperを読むが、この項を読む前に必ずしも読んで置く必要はない。つまりこのページが、アプリ開発者にとって、それらにとってかわる導入となりうることを意味する。

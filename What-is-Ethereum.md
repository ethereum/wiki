...
Gavin Wood has described Ethereum as being a collection of non-localized singleton programmable data structures. What this means will depend on where you are coming from, but where ever you are, it's going to be better with Ethereum.

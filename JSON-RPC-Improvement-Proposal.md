Note: The RPC is currently under heavy development, therefore not everything whats written here will work as expected with the latest develop branch. Please stay tuned while we fix that.

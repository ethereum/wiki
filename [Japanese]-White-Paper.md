...
80〜90年代にかけて、Chaum による "blinding署名" をよりどころとした
...
ABCD Hashcash パズル と b-money からアイデアから作られたシステムである、
...
2009年に、ナカモトサトシによる実用的な実装がはじめての分散型の通貨となりました。
これは、昔からあった「公開鍵暗号（所有権を管理) 」と
大衆意思決定アルゴリズムである「"proof of work" (誰がコインを所有しているのか追跡する)」
を結びあわせたものとなります。

proof of work のうしろにある技術は宇宙史に名を刻むほどの飛躍的進歩でありました。

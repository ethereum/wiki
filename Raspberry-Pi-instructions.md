...
(07.01.2016: download still not available, Gavin Wood referred to Christoph Jentzsch, waiting for response from @CJentzsch. It's 2.4 GB in size, if you want to save bandwidth, go and build it yourself, see instructions below)

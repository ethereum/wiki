...
2. Note that for those not familiar with arrays in programming languages, the index starts at 0, and increments by 1. So the nth item in an array has an index of n-1.
